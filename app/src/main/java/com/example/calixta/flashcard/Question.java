...
public class Question extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (allFlashcards != null && allFlashcards.size() > 0) {
            ((TextView) findViewById(R.id.first_question)).setText(allFlashcards.get(0).getQuestion());
            ((TextView) findViewById(R.id.answer)).setText(allFlashcards.get(0).getAnswer());
        } else {
            //else, add initial question to the database
            String inital_question = ((TextView) findViewById(R.id.first_question)).getText().toString();
            String inital_ans = ((TextView) findViewById(R.id.answer)).getText().toString();
        ...
        //when you click on the question, show the answer
        ...
        findViewById(R.id.next_button).setOnClickListener(new View.OnClickListener() {
            ...
            //switches text
            ((TextView) findViewById(R.id.first_question)).setText((allFlashcards.get(currentCardDisplayedIndex).getQuestion()));
